  ...
  try {
    ...
    if (aboutRes.ok) {
      ...
      if (elWelcomeText && about.descripcion) {
        ...
        let desc = about.descripcion.replace(/\*\*(.*?)\*\*/g, '<strong style="color:#d0a8f8;">$1</strong>');
            ...
            sortedMeds.forEach(m => {
              ...
              listHtml += `
                <div class="book-entry" style="margin-bottom:15px;">
                  <div class="book-author" style="color:#7a5a90;">${dateStr}</div>
      ...
      if (vidRes.ok) {
        ...
        if (vidData && vidData.items) {
          ...
          vidData.items.forEach(v => {
            ...
            let linkHtml = v.enlace ? `<a href="${v.enlace}" target="_blank" rel="noopener" style="font-family:'Press Start 2P',monospace; font-size:5px;">ver enlace ↗</a>` : '';
            ...
            let html = `
              <div class="book-entry">
                ...
                <div class="book-author" style="color:#7a5a90; margin-bottom:4px;">${v.subtitulo || v.categoria}</div>
